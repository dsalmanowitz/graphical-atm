...
public class EditView extends JPanel implements ActionListener {
	...
	private void initialize() {
		...
		nameLabel = new JLabel("Name: " + manager.getAcc().getUser().getName());
		...
		addressField = new JTextField("" + manager.getAcc().getUser().getStreetAddress());
		...
		cityField = new JTextField("" + manager.getAcc().getUser().getCity());
